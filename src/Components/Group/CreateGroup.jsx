            ...
            {!newGroup && (
                <div>
                    ...
                    <div className='relative bg-white py-4 px-3'>
                        <div className='flex space-x-2 flex-wrap space-y-1'>
                            {groupMember.size > 0 && Array.from(groupMember).map((item) => <SelectedMember handleRemoveMember={() =>
                                handleRemoveMember(item)} member={item} />)}
                        </div>
                    ...
                    <div className='bg-white overflow-y-scroll h-[50.2vh]'>
                        {
                            query && [1, 1, 1, 1, 1, 1, 1, 1, 1].map((item) => <div onClick={() => {
                    ...
                    <div className='bottom-10 flex py-10 bg-slate-200 items-center justify-center'>
